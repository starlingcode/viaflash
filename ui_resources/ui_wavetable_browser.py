...
class Ui_wavetableBrowser(object):
    def setupUi(self, wavetableBrowser):
        ...
        self.label_3 = QLabel(self.layoutWidgetNO)
        ...
        self.label_5 = QLabel(self.layoutWidgetNO)
        ...
        self.tableViz_2.addLayout(self.horizontalLayout_4)
        ...
        sizePolicy2.setHeightForWidth(self.viz3.sizePolicy().hasHeightForWidth())
        self.viz3.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.viz4.sizePolicy().hasHeightForWidth())
        self.viz4.setSizePolicy(sizePolicy2)
    ...
    def retranslateUi(self, wavetableBrowser):
        ...
        self.label_3.setText(QCoreApplication.translate("wavetableBrowser", u"Waveform", None))
        self.label_5.setText(QCoreApplication.translate("wavetableBrowser", u"Harmonics", None))
